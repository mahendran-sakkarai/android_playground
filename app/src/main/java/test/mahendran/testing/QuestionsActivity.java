...
public class QuestionsActivity extends AppCompatActivity implements InteractionListener {
    private int mCurrentQuestionIndex = 0;
    private ArrayList<Question> mQuestions;
    private Menu mMenu;
    private android.app.FragmentManager mFragmentManager;
    private HashMap<String, Object> mAnswers = new HashMap<>();
    public static final int ANSWER_REQUEST = 5777;
    ...
    private void updateQuestionView(int questionIndex) {
        ...
        fragment.setQuestionListener(this);
    ...
    public void onBackPressed() {
        if (mFragmentManager != null && mFragmentManager.getBackStackEntryCount() > 1) {
            ...
            setResult(Activity.RESULT_CANCELED, answerIntent);
            finish();
        } else {
            super.onBackPressed();
        }
    ...
    private void actionDone() {
        String answers = new Gson().toJson(mAnswers);
        Intent answerIntent = new Intent();
    ...
    @Override
    public void updateAnswer(String id, Object answer) {
        mAnswers.put(id, answer);
    }
}
